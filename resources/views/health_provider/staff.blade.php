                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="content-wrapper" style="background: #f8fafc;">
                                                        <div class="list-wrapper">
                                                            ...
                                                            <!-- New Employee -->
                                                            <form method="POST"
                                                                action="{{ $isUpdate ? route('health_provider.employee.update') : route('health_provider.employee.add.save') }}">

                                                                {{ @csrf_field() }}
                                                                <input name="active_tab" type="hidden"
                                                                    value="{{ $activeTab }}">
                                                                <input name="expert_id" type="hidden"
                                                                    value="{{ $selectedEmployees->id }}">

                                                                <div
                                                                    class="card col-md-10 offset-1 new-employee-wrapper">
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="name" type="text"
                                                                                    ...
                                                                                    name="name"
                                                                                    value="{{  $selectedEmployees->name }}{{ old('name') }}"
                                                                                    required autofocus>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="email" type="text"
                                                                                    class="form-control" placeholder=""
                                                                                    name="email"
                                                                                    value="{{  $selectedEmployees->email }}{{ old('email') }}"
                                                                                    required autofocus>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="phone" type="text"
                                                                                    class="form-control" placeholder=" "
                                                                                    name="phone"
                                                                                    value="{{  $selectedEmployees->phone }}{{ old('phone') }}"
                                                                                    required autofocus>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="employment_id" type="text"
                                                                                    class="form-control" placeholder=" "
                                                                                    name="employment_id"
                                                                                    value="{{  $selectedEmployees->employment_id }}{{ old('employment_id') }}"
                                                                                    required>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="qualification" type="text"
                                                                                    ...
                                                                                    name="qualification"
                                                                                    value="{{  $selectedEmployees->qualification }}{{ old('qualification') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row">
                                                                            ...
                                                                            <div class="col-md-8">
                                                                                <input id="specialization" type="text"
                                                                                    ...
                                                                                    name="specialization"
                                                                                    value="{{  $selectedEmployees->specialization }}{{ old('specialization') }}">
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group row permission-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="view_basic_info"
                                                                                        id="view_basic_info"
                                                                                        {{ old('view_basic_info') ? 'checked' : '' }}>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="view_medical_journal"
                                                                                        id="view_medical_journal"
                                                                                        {{ old('view_medical_journal') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="view_medical_journal">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="view_medical_background"
                                                                                        id="view_medical_background"
                                                                                        {{ old('view_medical_background') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="view_medical_background">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="update_medical_background"
                                                                                        id="update_medical_background"
                                                                                        {{ old('update_medical_background') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="update_medical_background">
                                                                        ...
                                                                        <div class="form-group row permission-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="view_recommended_test"
                                                                                        id="view_recommended_test"
                                                                                        {{ old('view_recommended_test') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="view_recommended_test">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        {{ old('view_test_results') ? 'view_test_results' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="remember">
                                                                                        View test results
                                                                                    </label>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        id="add_prescription"
                                                                                        {{ old('add_prescription') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="add_prescription">
                                                                                        Add prescription
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        ...
                                                                                        {{ old('view_prescription') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="view_prescription">
                                                                                        View prescription
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="view_issued_medicine"
                                                                                        id="view_issued_medicine"
                                                                                        {{ old('view_issued_medicine') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="view_issued_medicine">
                                                                        ...
                                                                        <div class="form-group row permission-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="verify_consultation_fee"
                                                                                        id="verify_consultation_fee"
                                                                                        {{ old('verify_consultation_fee') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="verify_consultation_fee">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="check_consultation_fee"
                                                                                        id="check_consultation_fee"
                                                                                        {{ old('check_consultation_fee') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="check_consultation_fee">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="verify_medicine_fee"
                                                                                        id="verify_medicine_fee"
                                                                                        {{ old('verify_medicine_fee') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="verify_medicine_fee">
                                                                                        Verify Medicine fee
                                                                                    </label>
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-md-6">
                                                                                <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                        type="checkbox"
                                                                                        name="check_medicine_fee"
                                                                                        id="check_medicine_fee"
                                                                                        {{ old('check_medicine_fee') ? 'checked' : '' }}>
                                                                                    <label class="form-check-label"
                                                                                        for="check_medicine_fee">
